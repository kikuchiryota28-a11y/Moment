  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 30px 70px rgba(0, 0, 0, 0.06), 0 10px 20px rgba(0, 0, 0, 0.04), inset 0 1px 1px rgba(255, 255, 255, 0.9), inset 0 -2px 15px rgba(255, 255, 255, 0.25)",
        borderRadius: "36px",
        padding: "32px",
      }}
    >
      <p className="m-0 text-[11px] font-black uppercase tracking-[0.22em] text-[#EF6B35]">
        TODAY&apos;S MOMENT
      </p>

      <div className="mt-6">
        <p className="m-0 text-[clamp(24px,4vw,34px)] font-semibold leading-[1.08] tracking-[-0.035em] text-[#1A1A1A]">
          {moment.prompt}
        </p>
        <p className="mt-7 text-[11px] font-bold uppercase tracking-[0.12em] text-black/45">
      ...
      <button
        ...
        className="mt-7 flex h-[56px] w-full items-center justify-center rounded-[18px] bg-[#1A1A1A] text-[12px] font-black uppercase tracking-[0.14em] text-[#FAF8F5] transition-transform active:scale-[0.985] disabled:cursor-default disabled:opacity-70"
      >
        {cta}
      </button>
    </div>
  ...
  return (
    <section
      ...
      style={{
        ...
        background: "radial-gradient(circle at 50% 40%, #FAF8F5 0%, #E5E0D8 60%, #D8D2C7 100%)",
      }}
      aria-label="MOMENT interactive space"
    >
      <div className="absolute top-[12%] left-[-2vw] z-[5] w-[104vw] pointer-events-none select-none">
        <p
          className="m-0"
          style={{
      ...
      <div className="pointer-events-none absolute left-5 top-5 z-[40] text-[10px] font-black uppercase tracking-[0.24em] text-black/45 sm:left-8 sm:top-8">
        MOMENT / 03
      </div>
