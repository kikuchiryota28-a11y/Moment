...
export interface Database {
  public: {
    Tables: {
      ...
      moments: {
        Row: { id: string; user_id: string; title: string; description: string; why: string | null; category: string; location_name: string | null; latitude: number | null; longitude: number | null; duration_minutes: number | null; estimated_cost: number | null; experience_note: string | null; rating: number; would_do_again: boolean; created_at: string; updated_at: string };
        Insert: Partial<Database["public"]["Tables"]["moments"]["Row"]> & Pick<Database["public"]["Tables"]["moments"]["Row"], "user_id" | "title" | "description" | "category" | "rating" | "would_do_again">;
      ...
      moment_passes: {
        Row: { id: string; moment_id: string; sender_id: string; recipient_id: string; created_at: string };
        Insert: Partial<Database["public"]["Tables"]["moment_passes"]["Row"]> & Pick<Database["public"]["Tables"]["moment_passes"]["Row"], "moment_id" | "sender_id" | "recipient_id">;
        Update: Partial<Database["public"]["Tables"]["moment_passes"]["Row"]>;
      };
    };
    Functions: {
