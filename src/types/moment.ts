...
export interface Journey { id: string; userId: string; momentId: string | null; status: JourneyStatus; plannedAt: string | null; startedAt: string | null; completedAt: string | null; experienceRecordedAt: string | null; experienceNote: string | null; experienceMediaUrl: string | null; experienceLocationName: string | null; createdAt: string; updatedAt: string; moment?: Moment; momentTitle?: string | null; momentCategory?: string | null; mediaUrl?: string | null; }
...
export interface MomentDetail { moment: Moment; author: Profile; isOwner: boolean; media: MomentMedia[]; social: { likeCount: number; commentCount: number; isLiked: boolean; isFollowingAuthor: boolean }; journey: { status: JourneyStatus | null }; experienceCount: number; comments: Comment[]; }
